...
<html>
  ...
  <h1 align="center">》新增员工资料</h1>
   	<s:form action="accountaction!add.action" method="post">
   		<s:textfield id="oid" name="employee.oid" label="员工编号"></s:textfield>
   		<s:textfield id="name" name="employee.employeeName" label="员工姓名"/>
   		<s:radio name="employee.sex" list="#{'男':'男','女':'女'}" listKey="key" listValue="value" label="性别" value="'男'"/>
   		<s:textfield id="doid" name="dep.oid" label="所属部门"/>
