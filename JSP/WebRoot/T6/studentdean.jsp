	   ...
	   <table width="30%" border="0" cellpadding="3" cellspacing="2" bgcolor="#CHDDCC" align="center">
	    ...
	    <tr valign="buttom" bgcolor="#FFFFFF">
	     ...
	     <tr valign="buttom" bgcolor="#FFFFFF">
	       ...
	       <td height="30%">
	          <div align="left">
	             <input name="marry" type="radio" id="marry" value="true" checked>已婚
	             <input name="marry" type="radio" id="marry" value="false">未婚
	          </div>
	       </td>
	     </tr>
	     <tr valign="buttom" bgcolor="#FFFFFF">
	       ...
	       <td height="50%">
	          <div align="left">
	             ...
	             <input type="checkbox" name="hobit" id="love" value="上网">上网
				 <input type="checkbox" name="hobit" id="love" value="睡觉">睡觉</br>
				 <input type="checkbox" name="hobit" id="love" value="羽毛球">羽毛球
				 <input type="checkbox" name="hobit" id="love" value="跑步">跑步
				 <input type="checkbox" name="hobit" id="love" value="其他">其他
	          </div>
	       </td>
	     </tr>
	      <tr valign="buttom" bgcolor="#FFFFFF">
