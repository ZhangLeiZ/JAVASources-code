  	...
  	<script type="text/javascript">
  		...
  		function datastud(data){
  			var tag = "";
					...
					tag+="</tr>";
					    tag+="<td><a href='javascript:void(0);' onclick=''>首页</a></td>";
				     	tag+="<td><a href='javascript:void(0);' >总页数 ${pager.sumpage}</a></td>";
				     	tag+="<td><a href='javascript:void(0);' onclick=''>上一页</a></td>";
				     	tag+="<td><a href='javascript:void(0);' onclick=''>下一页</a></td>";
				     	tag+="<td><a href='javascript:void(0);' onclick=''>尾页</a></td>";
					tag+="</tr>";
					$("#msg").html(tag);	
  		}
  	</script>
