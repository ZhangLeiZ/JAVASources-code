...
<html>
  <head>
    ...
    <title>My JSP 'Xmlajax.jsp' starting page</title>
    ...
    <script type="text/javascript">
  	...
  	if(xmlhttp.status==200){
  			...
  			for(var i=0;i<listdate.length;i++){
				...
				var sclass = listdate[i].childNodes[4].firstChild.nodeValue;
				row+="<td>"+sclass+"</td>";
				row+="</tr>";
  		   }
  	...
  	function vilisteraml(){
  	var param="";
  	var url="${pageContext.request.contextPath}/Xmlajaxservlet"
  ...
  <body>
    ...
    <hr>
    <input type="button" value="查询" id="click" align="center" onclick="vilisteraml();"/>
