...
<style type="text/css">
  ...
  #wrapper{position: relative;margin: 30px auto;width: 800px;height: 400px;}
  #banner{position:relative;width: 800px;height: 400px;overflow: hidden;}
  ...
  <div id="wrapper"><!-- 最外层部分 -->
    <div id="banner"><!-- 轮播部分 -->
      <ul class="imgList"><!-- 图片部分 -->
        <li><a href="#"><img src="./images/test1.jpg" width="800px" height="400px" alt="puss in boots1"></a></li>
      <li><a href="#"><img src="./images/test2.jpg" width="800px" height="400px" alt="puss in boots2"></a></li>
      <li><a href="#"><img src="./images/test3.jpg" width="800px" height="400px" alt="puss in boots3"></a></li>
      <li><a href="#"><img src="./images/test4.jpg" width="800px" height="400px" alt="puss in boots4"></a></li>
      <li><a href="#"><img src="./images/test5.jpg" width="800px" height="400px" alt="puss in boots5"></a></li>
      </ul>
