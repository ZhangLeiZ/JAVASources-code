...
public class ArrayListSearch extends JFrame implements ActionListener,KeyListener{

	/**
	 * 5.1.	结合前面GUI编程知识，实现一个简单的订单管理系统，
	...
	public ArrayListSearch() {
		...
		OrderList = new ArrayList<Orders2>();
...
//			Orders ord = new Orders(txtOrderId.getText(),txtOrderName.getText(),Double.parseDouble(txtPrice.getText()),txtAddr.getText());
			Orders2 ord = new Orders2();
