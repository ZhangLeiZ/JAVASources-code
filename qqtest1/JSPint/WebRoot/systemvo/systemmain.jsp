...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" /><%=new String(request.getParameter("name").getBytes("iso-8859-1"),"utf-8") %></h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<%=basePath %>cityservlet?order=list" target="right"><span class="icon-caret-right"></span>省份列表</a></li>
    <li><a href="<%=basePath %>privaceservlet?order=list" target="right"><span class="icon-caret-right"></span>城市列表</a></li>
    <li><a href="page.jsp" target="right"><span class="icon-caret-right"></span>查看课程</a></li>  
