...
public class testChatUI extends JFrame implements ActionListener,ItemListener,MouseListener{
	JLabel title,lbima;
	JTextPane recvepan,sendtext;
	JButton jbsend,jbclose,jbface,jbfile,jbcolor,jbshake;
	...
	public testChatUI(AccountVO myinfo ,AccountVO friendinfo) {
		super("QQ");
//		String str=myinfo.getNickName()+"("+myinfo.getQqCode()+")和";
//		str += friendinfo.getNickName()+"("+friendinfo.getQqCode()+")正在聊天...";
		String str="张三和李四正在聊天";
		setTitle(str);
		this.myinfo = myinfo;
		this.friendinfo = friendinfo;
//		setIconImage(new ImageIcon("headimg/1.png"));
		title = new JLabel(str,new ImageIcon("headimg/2.png"),JLabel.LEFT);
...
//			new Facepackage(this);
//			int fx=new Facepackage(this).getX();
//			int fy=new Facepackage(this).getY();
