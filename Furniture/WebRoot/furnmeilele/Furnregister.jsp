...
<head>
    ...
    <link rel="stylesheet" href="http://image.meilele.com/css/mll.common.new.min.css?20161107" />    <link rel="stylesheet" href="http://image.meilele.com/themes/paipai/css/user3.min.css?160603" />
...
<body class="root_body">
    <div id="" class="user_all w" style="position:relative;">
        <div id="" class="user_header clearfix" style="padding:30px 0px;">
            <div class="logo Left" style="background: url(http://image.meilele.com/images/flow2.png) 0 0 no-repeat;width:160px;height:52px">
                <a href="/" title="返回美乐乐首页">
                    <img style="background:none" src="http://image.meilele.com/images/blank.gif" width="160" height="52" border="0" alt="美乐乐">
                </a>
            </div>
            <div class="Left">
...
<div id="" class="user_content clearfix type_register">
    <div id="" class="user_login Left">
        <form id="JS_register_form">
            <div id="" class="register_box">
                <p>
                    <label class="tips"><span class="red">*</span>帐户名：</label>
                    <input type="text" name="user_name" class="register_input" id="register_username" autocomplete="off" tabindex="10"><span id="register_username_s" class="success" style="display:none;"></span>
                </p>
                ...
                <p>
                    ...
                    <input type="password" name="confirm_password" autocomplete="off" class="register_input" id="register_confirm_password" tabindex="12"><span id="register_rpw_s" class="success" style="display:none;"></span>
                </p>
                ...
                <p>
                    ...
                    <input type="text" name="mobile_phone" autocomplete="off" class="register_input" id="register_mobile" tabindex="13"><span id="register_mobile_s" class="success" style="display:none;"></span>
                </p>
                ...
                <p id="register_captcha_e">
                    ...
                    <img src="http://img004.mllres.com/themes/paipai/images/blank.gif" width="61" height="27" border="0" alt="" id="JS_captcha" style="cursor:pointer">
                    <a class="change-one" href="javascript:void(0);" id="JS_captcha_tip" tabindex="15">换一张</a>
                    <span id="register_ver_s" class="success" style="display:none;"></span>
                </p>
                <div id="register_captcha_a" class="error"></div>
                <p id="sms_captcha_e" style="display: none">
                    <label class="tips"><span class="red">*</span>短信验证码：</label>
                    <input type="test" name="sms_code" class="register_input" id="sms_captcha" tabindex="16">
                    <span id="sms_captcha_s" class="success" style="display:none;" maxlength="6"></span>
                    <span id="send_sms_captcha_wait" class="sms_captcha_wait_span"></span>
                    <a href="javascript:;" id="send_sms_captcha_a" class="get_sms_captcha_btn" onclick="UR.getSmsCaptcha();return false;">获取短信验证码</a>
                    <span id="sms_capteha_send" class="gray" style="display:none">&ensp;验证码已发送，请查收短信。</span>
                </p>
                <div id="sms_captcha_s_a" class="error" style="display: none;top:-22px;padding:5px;line-height:30px;height:30px;width:255px; text-indent:0;margin-top:-20px"></div>
                <p class="readed gray">
                    <input type="checkbox" id="sms_checked_look" checked></input><label>请阅读《<a href="/article_cat-15/article-300.html" target="_blank" class="blue" tabindex="17">美乐乐用户注册协议</a>》</label>
                </p>
                <div id="register_submit0" class="operate" style="padding-left:100px;">
                    <input type="button" class="regi_btn white f16 yahei clearfix" id="JS_register" tabindex="18" value="注册"></input>
                </div>
                <div id="register_submit1" class="operate none" style="padding-left:100px;">
                    <a class="register_submit register_submit2 f16 yahei" style="width:142px;_BACKGROUND-POSITION: -117px -40px;_PADDING-TOP: 6px" id="register_link"><img src="http://img001.mllres.com/themes/paipai/images/user/loading.gif" width="16" height="16" />正在注册...</a>
                </div>
            </div>
        </form>
    </div>
            <div id="" class="user_register Right" style="color:#555;">
                <div class="user_ok_register">
                    <span>已注册？</span><a href="<%=basePath %>/furnmeilele/Furnlogin.jsp" onclick="addRedirect(this);" class="logintoreg users_submit users_submit2 white yahei" style="color:#fff!important;font-size: 14px;">登录</a>
                </div>
...
</script>    <script type="text/javascript" src="${pageContext.request.contextPath}/js/regist.min.js"></script>
        ...
        (function(){
            var img_ewm = {
                ...
                ajaxLoad: function () {
                    var that = this;
                    $.ajax({
                        url: '/dubbo_api/user/newThird/createQrcode?type=login',
                        type:'get',
                        success: function (json) {
                            if (json && json.error == '0' && json.url) {
                                $('#JS_img_ewm').attr('src',json.url);
                                that.lisenLogin();
                            }
                        },
                        error: function () {
